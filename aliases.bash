...
# PCO
alias run-box-messagebus='bin/rails message_bus:aws:sqs:poller:run'
alias run-android='react-native run-android'
alias run-ios='run-iphone11pro'
alias run-iphone11='react-native run-ios --simulator="iPhone 11"'
alias run-iphone11pro='react-native run-ios --simulator="iPhone 11 Pro"'
alias run-iphone11pro-max='react-native run-ios --simulator="iPhone 11 Pro Max"'
